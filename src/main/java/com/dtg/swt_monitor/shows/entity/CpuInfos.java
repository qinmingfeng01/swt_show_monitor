...
public class CpuInfos {
    ...
    public CpuInfos(String id, String ip, String errorCupRate, String cpuBindCount, String cpuMhz, String useRate, String freeRate, String cpuType, String cpuVendor, String cacheSize, String cpuSort, String createTime, int totalCores) {
        this.id = id;
        this.ip = ip;
    ...
    public CpuInfos(String ip, String errorCupRate, String cpuBindCount, String cpuMhz, String useRate, String freeRate, String cpuType, String cpuVendor, String cacheSize, String cpuSort, String createTime, int totalCores) {
        this.ip = ip;
        this.errorCupRate = errorCupRate;
        this.cpuBindCount = cpuBindCount;
        this.cpuMhz = cpuMhz;
