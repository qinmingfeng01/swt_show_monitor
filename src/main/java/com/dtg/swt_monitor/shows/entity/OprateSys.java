...
public class OprateSys {
    ...
    public OprateSys(String id, String ip, String pcName, String arch, String dataModel, String description, String vendor, String vendorCodeName, String vendorName, String version, String createTime) {
        this.id = id;
        this.ip = ip;
        this.pcName = pcName;
        this.arch = arch;
