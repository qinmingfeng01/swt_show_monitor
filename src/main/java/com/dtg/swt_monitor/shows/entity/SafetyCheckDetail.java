...
public class SafetyCheckDetail {
    ...
    private String createTime;//扫描时间

    public SafetyCheckDetail(String id, String ip, String zeroID, String pid, String processName, String runTime, String processPath, String processPathIsSafety, String createTime) {
        this.id = id;
        this.ip = ip;
        this.zeroID = zeroID;
        this.pid = pid;
